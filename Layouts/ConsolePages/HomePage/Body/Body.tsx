...
import Card from "../../../../Components/ConsolePages/HomePageCards/Card";
  ...
  return (
    <BodyContent className="flex fd-col">
        ...
        <BodyUpperContent className="row">
          <div className="left flex col-n-7">
            <div className="flex fd-col js-center">
              <p className="size:5xl color:white bold-600">Welcome, {userName}</p>
      ...
      <BodyLowerContent className="col-n-12">
        <Cards className="block m-auto-rl">
          <Card />
        </Cards>
